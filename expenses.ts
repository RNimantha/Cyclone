...
// Utility functions
function formatExpenseCurrency(amount: number): string {
...
function updateExpensesDashboard(totalAmount: number, totalExpenses: number): void {
...
function updateCategoryChart(categories: Record<string, number>): void {
...
function updateCategoryFilters(categories: Record<string, number>): void {
...
function updateExpenseTable(expenses: ProcessedExpense[], categoryFilter: string | null = null): void {
...
function updateReceiptChart(withAmount: number, withoutAmount: number, withCount: number, withoutCount: number): void {
...
function updateTimeChart(expenses: ProcessedExpense[]): void {
...
function updateTopPurposesChart(expenses: ProcessedExpense[]): void {
...
function updateRecentExpenses(expenses: ProcessedExpense[]): void {
